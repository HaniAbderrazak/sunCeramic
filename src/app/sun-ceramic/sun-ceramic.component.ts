...
export class SunCeramicComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  translations: any = {
    en: {
      ...
      gardenDesc: 'Weather-resistant ceramic pots and planters for stunning outdoor spaces',
    ...
    pt: {
      ...
      gardenDesc: 'Vasos e plantadores cerâmicos resistentes para espaços exteriores deslumbrantes',
      kitchen: 'Elementos Cozinha',
    ...
    es: {
      ...
      gardenDesc: 'Macetas y plantadores de cerámica resistentes para espacios exteriores impresionantes',
      kitchen: 'Elementos Cocina',
    ...
    fr: {
      ...
      gardenDesc: 'Pots et jardinières en céramique résistants aux intempéries pour des espaces extérieurs magnifiques',
      kitchen: 'Éléments Cuisine',
    ...
    ar: {
      ...
      gardenDesc: 'أصص وزراعات سيراميك مقاومة للعوامل الجوية للمساحات الخارجية المذهلة',
